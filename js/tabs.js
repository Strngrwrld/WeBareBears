(function(){
    ...
    primer_encabezado: document.getElementById('personaje').firstElementChild,
    primer_contenido: document.getElementById('historia_personaje').firstElementChild,
    enlaces_encabezado:document.querySelectorAll('#personaje li a'),
    li_encabezado: document.querySelectorAll('#personaje li'),
    divs_contenido: document.querySelectorAll('#historia_personaje > div'),
